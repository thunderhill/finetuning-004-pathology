...
\texttt{p.mahipal@tcs.com} \quad \texttt{saikalyan.guddeti@tcs.com}\\
...
stain augmentation on deployment robustness, demonstrating a $3.4\times$ reduction in OOD
accuracy degradation (44.0 $\to$ 12.9 points) at a cost of only 0.6 points of
in-distribution accuracy. (3) A systems account of training large ViTs in
